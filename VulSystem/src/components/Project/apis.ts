...
export const updateProject = (project: FormData) => {
  return new Promise((resolve, reject): ProjectCreateResponse => {
    instance.post(`/project/update`, project).then((res: AxiosResponse<ProjectCreateResponse>) => {
      resolve(res.data)
    }).catch((err: AxiosError) => {
      console.error(err)
      reject(err)
...
export const deleteProject = (project: FormData) => {
  return new Promise((resolve, reject): ProjectCreateResponse => {
    instance.post(`/project/delete`, project).then((res: AxiosResponse<ProjectCreateResponse>) => {
      resolve(res.data)
    }).catch((err: AxiosError) => {
      console.error(err)
      reject(err)
...
export const getProjectList = (page:number, size: number, companyId:number) => {
  return new Promise((resolve, reject): ProjectListResponse => {
    instance.get(`/project/list?page=${page}&size=${size}&companyId=${companyId}`).then((res: AxiosResponse<ProjectListResponse>) => {
      resolve(res.data)
    }).catch((err: AxiosError) => {
      console.error(err)
      reject(err)

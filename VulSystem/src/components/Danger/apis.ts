...
export const getVulnerabilityReportList = (page: number, size: number) => {
  return new Promise((resolve, reject): VulnerabilityReportListResponse => {
    instance.get(`/vulnerabilityReport/list?page=${page}&size=${size}`).then((res: AxiosResponse<VulnerabilityReportListResponse>) => {
      resolve(res.data)
...
export const getVulnerabilityReportSearch = (keyword: string) => {
  return new Promise((resolve, reject) => {
    instance.get(`/vulnerabilityReport/search?keyword=${keyword}`).then((res: AxiosResponse<VulnerabilityReportSearchResponse>) => {
      resolve(res.data)
    }).catch((err: AxiosError) => {
      console.error(err)
      reject(err)
...
export const getFilteredVulnerabilityReport = (riskLevel?: string, startDate?: string, endDate?: string) => {
  ...
  return new Promise((resolve, reject) => {
    instance.get(url).then((res: AxiosResponse<VulnerabilityReportSearchResponse>) => {
      resolve(res.data)
    }).catch((err: AxiosError) => {
      console.error(err)
      reject(err)
